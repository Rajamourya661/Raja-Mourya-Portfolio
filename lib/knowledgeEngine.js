  ...
  /* ── Certifications (stored as "publications" in profile.json) ── */
  {
    ...
    build() {
      ...
      return {
        ...
        actions: [
          { type: 'navigate', label: '📜 Certifications Section', section: 7 },
          { type: 'link', label: '💼 LinkedIn', href: getSocial('LinkedIn') },
        ],
      };
    },
  ...
  /* ── Achievements ── */
  {
    ...
    build() {
      ...
      return {
        ...
        actions: [
          { type: 'navigate', label: '🏆 Achievements Section', section: 6 },
        ],
      };
    },
  },
  ...
  /* ── Experience ── */
  {
    ...
    build() {
      ...
      return {
        ...
        actions: [
          { type: 'navigate', label: '💼 Experience Section', section: 5 },
          { type: 'link', label: '📄 View Resume', href: '/assets/Raja_Mourya_Cybersecurity_Resume.pdf' },
        ],
      };
    },
  ...
  /* ── Research ── */
  {
    ...
    build() {
      ...
      return {
        ...
        actions: profile.research.filter(r => r.link).map(r => ({
    ...
    build() {
      ...
      return {
        ...
        actions: [
          ...
          { type: 'navigate', label: '📬 Contact Section', section: 9 },
        ],
      };
    },
  },
